//! Low-level system utilities for the ferropin crate.
//!
//! This module provides low-level system call wrappers using inline assembly.
//! These utilities are used by other modules to interact with Linux system calls directly.
//!
//! # Important Note
//!
//! This module is specific to ARM64 architecture (aarch64) and uses direct system calls
//! rather than relying on libc wrappers. This approach is useful in environments where
//! libc may not be available or when precise control over system calls is needed.
//!
//! # Safety
//!
//! This module uses `unsafe` blocks for inline assembly and system calls. Users of this
//! module should ensure they understand the implications of direct system call usage.
//!
...
/// Opens a file using the openat system call
///
/// # Arguments
///
...
/// Performs an ioctl request on a file descriptor
///
/// # Arguments
///
